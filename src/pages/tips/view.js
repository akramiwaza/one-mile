...
import { ManageTips, DeleteTips, EditTips, GetTips } from "./actions";
import DynamicModal from "src/components/modal/DynamicModal";
import * as Yup from "yup";
import { CommonAlert } from "src/components/alert/CommonAlert";
import { GetCategoryAcitivities } from "../activities/category/actions";
const Tips = () => {
  ...
  const columns = [
    ...
    { type: columntype.text, name: "activite_category" },
  ...
  const headCells = [
    ...
    {
      id: "activite_category",
      numeric: false,
      disablePadding: false,
      label: "Activite category",
      withSort: false,
    },
    {
      id: "created_date",
    ...
    (dataPrivileges["11"]?.access_edit == 1 ||
      dataPrivileges["11"]?.access_delete == 1) && {
      id: "action",
      numeric: false,
      disablePadding: false,
      label: "Action",
  ...
  return (
    <>
      <DynamicTable
        ...
        withAddButton={dataPrivileges["11"]?.access_write == 1 ? true : false}
        withDeleteItem={dataPrivileges["11"]?.access_delete == 1 ? true : false}
        withEditItem={dataPrivileges["11"]?.access_edit == 1 ? true : false}
      ...
      {showModal ? (
        <DynamicModal
          ...
          title={"Tips"}
          editMode={editMode}
          description={editMode ? "Edit" : "Add new Tips"}
