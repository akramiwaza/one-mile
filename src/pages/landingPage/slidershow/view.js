...
const SliderShow = () => {
  ...
  const Schema = Yup.object().shape({
    ...
    button_color: Yup.string().trim().nullable().required("required"),
    background_color: Yup.string().trim().nullable().required("required"),
    ...
    <>
      ...
      {showModal ? (
        <DynamicModal
          ...
          title={"Slidershow"}
          editMode={editMode}
          description={editMode ? "Edit" : "Add new slidershow"}
