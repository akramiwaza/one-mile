...
const Data = [
  {
    title_en: "Product A (English)", // Title in English
    title_ar: "المنتج أ", // Title in Arabic
    unit: "piece", // Unit (e.g., piece, kg, liter)
    price: 100, // Price of the product
  },
  {
    title_en: "Product B (English)",
    title_ar: "المنتج ب",
    unit: "kg",
    price: 200,
  },
  {
    title_en: "Product C (English)",
    title_ar: "المنتج ج",
    unit: "liter",
    price: 150,
  },
...
const fields = [
  { key: "title_en", label: "Title (English)" }, // English title
  { key: "title_ar", label: "Title (Arabic)" }, // Arabic title
  { key: "unit", label: "Unit" }, // Unit (e.g., piece, kg, liter)
  { key: "price", label: "Price" }, // Price field
];
      ...
      >
        ...
        >
          ...
          <Button
            variant="contained"
            color="primary"
            onClick={() => navigate("/additional-charge/create")}
          >
